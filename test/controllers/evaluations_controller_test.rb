...
class EvaluationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evaluation" do
    assert_difference('Evaluation.count') do
      post evaluations_url, params: { evaluation: { fecha: @evaluation.fecha, objetivo: @evaluation.objetivo } }
    end
  ...
  test "should update evaluation" do
    patch evaluation_url(@evaluation), params: { evaluation: { fecha: @evaluation.fecha, objetivo: @evaluation.objetivo } }
