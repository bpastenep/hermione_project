...
class PurposesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purpose" do
    assert_difference('Purpose.count') do
      post purposes_url, params: { purpose: { descripcion: @purpose.descripcion, rda_especific_id: @purpose.rda_especific_id } }
    end
  ...
  test "should update purpose" do
    patch purpose_url(@purpose), params: { purpose: { descripcion: @purpose.descripcion, rda_especific_id: @purpose.rda_especific_id } }
